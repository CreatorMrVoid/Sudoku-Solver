...
class SudokuGame:
    ...
    def __init__(self, root: tk.Tk):
        ...
        # Set minimum window size (increased height to show all content)
        self.root.minsize(1000, 950)
        
        # Center window on screen (increased height for new design)
    ...
    def _create_ui(self):
        ...
        # Create two rows for buttons to ensure all are visible
        ...
        # Primary buttons - Row 1 (4 buttons)
